	...
	<form action="${ctx}/vedsb/cgptsz/jpptzcfzsz/saveFzsz" id="fzszForm" method="post" >
		...
		<table cellpadding="0" class="list_table" cellspacing="0" style="width: 800px" id="insertRow1">
			<tr>
				...
				<td align="center"><img src="${ctx}/static/images/wdimages/drop-add.gif" title="点击添加" onclick="addTr('insertRow1','tpl1', -1);"/></td>
			</tr>
			...
			<tr>
				...
				<td align="center"><img src="${ctx}/static/images/wdimages/drop-no.gif" title="点击删除" onclick="delTr('insertRow1', this, '');"/></td>
			</tr>
			</script>
			<c:forEach items="${fzszList }" var ="fzsz"  varStatus="i">
				<tr>
					...
					<td align="center"><img src="${ctx}/static/images/wdimages/drop-no.gif" title="点击删除" onclick="delTr('insertRow1', this, '${fzsz.id}');"/></td>
				</tr>
			</c:forEach>
		</table>
	</form>
