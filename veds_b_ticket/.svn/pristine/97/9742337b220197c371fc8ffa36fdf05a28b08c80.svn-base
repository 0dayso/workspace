...
<c:when test="${not empty detailList or fn:length(detailList) gt 0}">
	<display:table id="vc_asms" name="detailList" class="list_table" decorator="org.displaytag.decorator.TotalTableDecorator"
	 style="width:100%;white-space: nowrap;" length="20">
