...
<body>
	<div style="background: #fff;">
							...
							<tr>
								<td>
									<form id="asmsForm" name="asmsForm" action="${ctx}/vedsb/jpcwgl/jpysdz/genSystemData" method="post" target="asmsiframe">
										...
										<input type="hidden" name="wdpt" value="10100010">
					...
					<td valign="top" style="padding-top:4px;">
						<table class="bank_form" height="84px;" width="100%" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<span>
										<a href="https://mppm.qunar.com/qunarMerchantManager/login.do" target="blank">点击前往去哪儿后台下载账单</a>
									</span>
									<span style="margin-left:150px;">
										<a href="###" onclick="showXzbz(2)">下载说明</a>
									</span>
								</td>
								<td style="align:left;">
		...
		<div id="bank_ti" class="div_s_top_right" style="margin-top:5px;">去哪儿账单</div>
