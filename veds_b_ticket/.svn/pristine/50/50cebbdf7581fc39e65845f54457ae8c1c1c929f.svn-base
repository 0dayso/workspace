...
<body>
	<div style="background: #fff;">
			...
			<table width="99%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td style="width:40%;padding-top:4px;">
						...
						<input type="hidden" name="wdmc" value="${param.wdmc}" id="wdmc" />
							<tr>
								...
								<td>
									<span style="font-weight: bold;color: #3E75D0;font-size:14px;" id="spmc">
							...
							<tr>
								...
								<td>
									...
									<span style="margin-left:150px;">
										<a href="###" onclick="showXzbz(1)">下载说明</a>
									</span>
								</td>
								<td style="align:left;">
		...
		<div id="bank_ti" class="div_s_top_right" style="margin-top:5px;">淘宝账单</div>
		<div id="asms_date" class="div_s_data_left">
			<iframe width="98%" id="asmsiframe" name="asmsiframe" height="430" frameborder="1" scrolling="auto" style="posotion:relative" onload="iframOnloadEven()"></iframe>
		</div>
		<div id="bank_date" class="div_s_data_right">
			<iframe width="98%" id="hiddeniframe" name="hiddeniframe" height="430" frameborder="1" scrolling="auto" style="posotion:relative" onload="iframOnloadEven()"></iframe>
		</div>
		<div class="clear"></div>
