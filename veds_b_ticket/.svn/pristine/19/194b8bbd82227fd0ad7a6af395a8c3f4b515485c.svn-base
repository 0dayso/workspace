...
<table class="table01" border="0" cellpadding="0" cellspacing="0"> 
	...
	<tr >
	    ...
	    <td class="xsys" style="text-align: right;">票号</td>
	  	<td>
	  		<input type="text" class="input1" size=10 value="${param.tkno}" name="tkno" onblur="checkTkno($.trim(this.value).toUpperCase());" id="tkno" datatype="*14-14"/>
	  	</td>
	  	 <td class="xsys" style="text-align: right;">航空公司</td>
		 <td>
		 	<input type="text" id="hkgsmc" name="hkgsmc" size=10 onchange="clearValue(this,'gxhs');" onkeyup="this.value=this.value.toUpperCase()" value="${param.hkgsmc}"/>
