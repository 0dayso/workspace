    	...
    	validator = $("#tpdxsshform").Validform({
			...
			callback:function(transport){
				if(transport.status == 'ok'){
				   ...
				   layer.alert("采购办理成功",1, '提示信息',function index(){
								window.close();
               			 });
				}else{
        ...
        <div class="box">
          <div class="box_border">
            <div class="box_center" style=" width:100%; background:#fff ;float:left">
              <form action="${ctx}/vedsb/jptpgl/jptpdcg/tpdCgWc_${jptpd.tpdh}" class="tpdxsshform" id="tpdxsshform" method="POST">
	          ...
	          <input type="hidden" name="close" value="true">
               ...
               <br>
				<table style="width: 100%">
					<tr>
						<td align="center">
						<input type="button" name="button"	onclick="toCgWc()" class="ext_btn ext_btn_submit" value="确认">&nbsp;
