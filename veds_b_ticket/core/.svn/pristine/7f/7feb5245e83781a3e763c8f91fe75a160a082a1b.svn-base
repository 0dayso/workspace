...
public class Threads {
	...
	public static String getQueueInfo(ExecutorService CRAWLSERVICE) {
		ThreadPoolExecutor exec_ = (ThreadPoolExecutor) CRAWLSERVICE;
		StringBuffer str = new StringBuffer();
		str.append("\r\n"+VeDate.getStringDate() + "===========================");
		str.append("\r\nexec.getTaskCount():" + exec_.getTaskCount());
		str.append("\r\nexec.getCompletedTaskCount():" + exec_.getCompletedTaskCount());
		str.append("\r\nexec.getActiveCount():" + exec_.getActiveCount());
		str.append("\r\nexec.getPoolSize():" + exec_.getPoolSize());
		str.append("\r\nexec.getQueue():" + exec_.getQueue().size());
		str.append("\r\n===========================");
		return str.toString();
	}
