...
public class ColumnTagBeanInfo extends SimpleBeanInfo
{
    ...
    public PropertyDescriptor[] getPropertyDescriptors()
    {
        ...
        try
        {
            ...
            // make ATG Dynamo happy:
            proplist.add(new PropertyDescriptor("expfield", //$NON-NLS-1$
                ColumnTag.class,
                null,
                "setExpfield")); // map //$NON-NLS-1$
            // set href tag title
            proplist.add(new PropertyDescriptor("hrefTitle", //$NON-NLS-1$
                ColumnTag.class,
                null,
                "setHrefTitle")); // map //$NON-NLS-1$
            // set link cell click method
            proplist.add(new PropertyDescriptor("onclick", //$NON-NLS-1$
                ColumnTag.class,
                null,
                "setOnclick")); // map //$NON-NLS-1$
