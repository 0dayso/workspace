...
public class MapperHelper {
	private final Logger logger = LoggerFactory.getLogger(MapperHelper.class);
    /**
     * 注册的通用Mapper接口
     */
    ...
    public void setSqlSource(MappedStatement ms) {
        ...
        try {
        	...
        	logger.error(e.getMessage()+"错误源为："+ms.getId(),e);
    ...
    public void processConfiguration(Configuration configuration) {
        ...
        //当参数的值为null的时候会mybatis不知道如何转换类型，因此会报错，所以需要设置一个NULL
