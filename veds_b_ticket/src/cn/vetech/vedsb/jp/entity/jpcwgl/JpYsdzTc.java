...
@Table(name="JP_YSDZ_TC")
public class JpYsdzTc extends AbstractPageEntity{
	...
	public void setWdJydfmc(String wdJydfmc){
		this.wdJydfmc=StringUtils.trim(wdJydfmc);
	}
	public String getWdJydfmc(){
		return this.wdJydfmc;
	}
