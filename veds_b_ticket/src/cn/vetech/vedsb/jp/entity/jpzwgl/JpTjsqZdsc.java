...
@Table(name="JP_TJSQ_ZDSC")
public class JpTjsqZdsc extends AbstractPageEntity{
	...
	/**常旅客ID,VIP申请使用*/
	private String sqClkid;
	/**差旅用户现在部门,VIP申请使用*/
	private String sqClkDeptid;
	/**原订单的PNR*/
	...
	public void setSqClkid(String sqClkid){
		this.sqClkid=StringUtils.trim(sqClkid);
	}
	public String getSqClkid(){
		return this.sqClkid;
	}

	public void setSqClkDeptid(String sqClkDeptid){
		this.sqClkDeptid=StringUtils.trim(sqClkDeptid);
	}
	public String getSqClkDeptid(){
		return this.sqClkDeptid;
	}
	...
	public void setDpDeptid(String dpDeptid){
		this.dpDeptid=StringUtils.trim(dpDeptid);
	}
	public String getDpDeptid(){
		return this.dpDeptid;
	}
