            ...
            <div class="box_center">
            		<table  class="table01" width="100%" border="0" cellpadding="0" cellspacing="0" id="zdcpgzsztab">
            			...
            			<tr>
            				...
            				<td>
            					<input type="radio" name="kqkhbbj" value="1" id="kqbj" ${entity.kqkhbbj eq '1' or empty entity.kqkhbbj ? 'checked' : '' }/><label for="kqbj">开启</label>&nbsp;&nbsp;
            					<input type="radio" name="kqkhbbj" value="0" id="nkqbj" ${entity.kqkhbbj eq '0' ? 'checked' : '' }/><label for="nkqbj">关闭</label>
            				</td>
            			</tr>
            			<tr>
            					...
            					<table class="table01" width="100%" border="0" cellpadding="0" cellspacing="0">
            						<tr>
            							...
            							<td>
            								...
            								<input type="checkbox" name="bjCybjzcs" id="bjCybjzc2" value="10100011" onclick="changecybjze(this)"/><label for="bjCybjzc2">淘宝旗舰店</label>&nbsp;&nbsp;
            								 <c:forEach items="${vfc:getVeclassLb('100021')}" var="oneLx" varStatus="v">
            								 	<c:if test="${oneLx.id ne 100021}">
            								 		<input type="checkbox" name="bjCybjzcs" id="bjCybjzc${oneLx.id}" value="${oneLx.id}" onclick="changecybjze(this)"/><label for="bjCybjzc${oneLx.id}">${oneLx.mc }</label>&nbsp;&nbsp;
            								 	</c:if>
            								 </c:forEach>
            			...
            			<tr>
            				...
            				<td>
            					<input type="checkbox" value="1" name="checkosis" id="checksjh" onclick="changecheck(this)"><label for="checksjh">检查订单乘机人手机号</label>
			                   	...
			                   	<input type="hidden" name="sfjcosi" id="checkosi" value="${entity.sfjcosi}"/>
            				</td>
            			</tr>
            			<tr>
            			...
            			<tr>
            				...
            				<td><font id="cplxyxjpxbsp">BSPET</font><font><a  style="text-decoration:none;cursor:pointer;padding-left: 6px;padding-right: 6px;"><img src="${ctx}/static/images/jzcp/change_arrow.png"/></a></font> <font id="cplxyxjpxbp">BPET</font></td>
            			...
            			<tr>
            				...
            				<td>
            				<font ptid="10002101" class="each">CPS</font>
            				<c:if test="${not empty ptbjPtyxjArray}">
            					<c:forEach items="${ptbjPtyxjArray}" var="array">
            						<c:forEach items="${vfc:getVeclassLb('100021')}" var="oneLx" varStatus="v">
            							<c:if test="${array eq oneLx.id and oneLx.id ne '10002101' and oneLx.id ne '100021'}">
	            							<font><a  style="text-decoration:none;cursor:pointer;padding-left: 6px;padding-right: 6px;"><img src="${ctx}/static/images/jzcp/change_arrow.png"/></a></font>
		           							<font ptid="${oneLx.id}" class="each">${oneLx.mc}</font>
            							</c:if>
            						</c:forEach>
            						<c:if test="${array eq vfc:getVeclass('10100011').id}">
            								<font><a style="text-decoration:none;cursor:pointer;padding-left: 6px;padding-right: 6px;"><img src="${ctx}/static/images/jzcp/change_arrow.png"/></a></font>
		           							<font ptid="${vfc:getVeclass('10100011').id}" class="each">${vfc:getVeclass('10100011').mc}</font>
            					    </c:if>
            					</c:forEach>
            				</c:if>
            				<c:if test="${empty ptbjPtyxjArray}">
            					<font><a " style="text-decoration:none;cursor:pointer;padding-left: 6px;padding-right: 6px;"><img src="${ctx}/static/images/jzcp/change_arrow.png"/></a></font>
		           				<font ptid="${vfc:getVeclass('10100011').id}" class="each">${vfc:getVeclass('10100011').mc}</font>
           						<c:forEach items="${vfc:getVeclassLb('100021')}" var="oneLx" varStatus="v">
           							<c:if test="${oneLx.id ne '10002101' and oneLx.id ne '100021'}">
	           							<font><a   style="text-decoration:none;cursor:pointer;padding-left: 6px;padding-right: 6px;"><img src="${ctx}/static/images/jzcp/change_arrow.png"/></a></font>
	           							<font ptid="${oneLx.id}" class="each">${oneLx.mc}</font>
           							</c:if>
           						</c:forEach>
           					</c:if>
           					<input type="hidden" name="ptbjPtyxj" id="ptbjPtyxj" value="${empty entity.ptbjPtyxj ? '10002101/10100011/10002102/10002103/10002104/10002105/10002106/10002107' : entity.ptbjPtyxj}"/>
            				</td>
            			</tr>
            			<tr>
