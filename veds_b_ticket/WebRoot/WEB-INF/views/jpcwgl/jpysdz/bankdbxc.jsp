...
<body>
	<div style="background: #fff;">
							...
							<tr>
								<td>
									<form id="asmsForm" name="asmsForm" action="${ctx}/vedsb/jpcwgl/jpysdz/genSystemData" method="post" target="asmsiframe">
										...
										<input type="hidden" name="wdpt" value="10100050">
					...
					<td valign="top" style="padding-top:4px;">
						<table class="bank_form" height="84px;" width="100%" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<span>
										<a href="https://tbooking.ctrip.com/Tbooking/login.aspx" target="blank">点击前往携程后台下载账单</a>
									</span>
									<span style="margin-left:150px;">
										<a href="###" onclick="showXzbz(3)">下载说明</a>
									</span>
								</td>
								<td style="align:left;">
		...
		<div id="bank_ti" class="div_s_top_right" style="margin-top:5px;">携程账单</div>
