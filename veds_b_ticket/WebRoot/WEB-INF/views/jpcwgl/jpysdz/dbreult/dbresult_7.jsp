...
<%@ include file="/WEB-INF/layouts/taglibs.jsp"%>
	<display:merge title="系统数据">
		...
		<display:column title="对比结果" style="text-align:center" expfield="JESFZQ">
			<c:if test="${vc.JESFZQ eq '1'}">金额正确</c:if>
			<c:if test="${vc.JESFZQ eq '2'}"><font color="red">金额错误</font></c:if>
		</display:column>
