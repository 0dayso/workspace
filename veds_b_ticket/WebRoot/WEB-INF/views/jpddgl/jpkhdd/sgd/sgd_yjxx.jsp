...
<input type="hidden" name="ps_yqdatetime" value="${kh_khdd_pn.YJSJ}" >
<c:set var="ps_lx" value="${empty kh_khdd_pn.SFYJXCD ? '0' : kh_khdd_pn.SFYJXCD}" />
					...
					<td>
						...
						<span id="yjtr" style="display: ${ps_lx eq '1' ? '' : 'none'}">
							<span class="fl">
								...
								<span id="tdsjr">
									<input type="text" name="sjr" id="sjr" required="required" value="${kh_khdd_pn.SJR}" size="9" maxlength="60" ${ps_lx eq '1' ? "datatype='*1-20' " : ''} />
									<font color="red">*</font>
								</span>&nbsp;&nbsp;
							</span>
							...
							<span class="fl">
								...
								<span id="tdlxrdh">
									<input type="text" name="sjrdh" id="sjrdh" ${ps_lx eq '1' ? "datatype='m' " : ''}
										value="${empty kh_khdd_pn.NXSJ ? kh_khdd_pn.NXDH : kh_khdd_pn.NXSJ}" style="width: 80px"/>
									<font color="red">*</font>
								</span>&nbsp;&nbsp;
							</span>
							...
							<span class="fl">
								...
								<span id="tdyjfy" style="margin-left:6px;">
									<input type="text" id="yjf" name="xs_yjf" value="${empty kh_khdd_pn.XS_YJF ? 0 : kh_khdd_pn.XS_YJF}" onblur="" ${ps_lx eq '1' ? "datatype='n1-5' " : ''}  style="width: 50px" />
								</span>&nbsp;&nbsp;
							</span>
							<label class="headtitle" id="thyzbm" style="width: 70px;">邮政编码</label>
							<span id="tdyzbm" style="margin-left:6px;">
								<input type="text" id = "yzbm" name="yzbm" value="${kh_khdd_pn.YZBM }" ${ps_lx eq '1' ? "datatype='p' ignore='ignore'" : ''}  style="width: 50px"/>
							</span>
						</span>
					</td>
				</tr>
					...
					<td>
						...
						<span id="yjfytr">
							<span id="tdsjdz" style="margin-left:6px;">
								<input type="text" id = "xjdz" name="xjdz" style="width: 650px;" value="${kh_khdd_pn.XJDZ}" 
