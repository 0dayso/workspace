...
<tbody> 
	<!--第1行 -->
		...
		<tr>
			 ...
			 <td class="ptzh_left">
				<input name="user1" type="text" style="width:150px" title="" value="${ptzh.user1 }" >	
			</td>
			 <td class="ptzh_right">  用户名：</td>
			 <td class="ptzh_left">
				<input name="user2" type="text"  style="width:150px" title="" value="${ptzh.user2 }" >
			</td>
		</tr>
		<!--第3行 -->
		<tr> 
			 ...
			 <td class="ptzh_left">
				 <input name="url1" type="text" style="width:150px" value="${empty ptzh.url1 ? 'http://ite2.baitour.com' : ptzh.url1 }"  title="查询政策和下单地址">
			</td>
		</tr>
		<!--第4行 -->
		<tr> 
			 ...
			 <td class="ptzh_left">
				<input type="text" name="url2" style="width:150px" value="${empty ptzh.url2 ? 'http://co.baitour.com/copayment/PortFlightPayment.aspx' : ptzh.url2}"  title="支付地址">
			</td>
